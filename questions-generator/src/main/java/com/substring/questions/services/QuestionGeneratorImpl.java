...
import com.substring.questions.repository.QuestionRepo;
...
public class QuestionGeneratorImpl implements QuestionGenerator{
    ...
    public List<QuestionDto> generateQuestions(String quizName, int numberOfQuestions, String description) {
        ...
        String systemString= """
                AS a codding, Technology, Programing & FrameWork expert, your primary role is to generate high quality questions for quiz 
                """;

        String promptString= """
                Generate {numberOfQuestions} question for {quizName} quiz.
                Having description {description}
                 """;

        Map<String, Object> valueForPrompt=Map.of(
        ...
        this.chatClient
                .prompt()
                .system(systemString)
                .user(userSpec->userSpec.text(promptString).params(valueForPrompt))
                .call()
